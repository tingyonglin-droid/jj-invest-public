...
describe("history UI", () => {
  ...
  it("uses the rebalance title structure and exact heading rhythm", () => {
    ...
    assert.match(styles, /\.historySummaryCard \.cardTitleRow h2,\s*\.historyChartCard \.cardTitleRow h2,\s*\.historyRecordsCard \.cardTitleRow h2\s*\{[^}]*font-size:\s*18px;[^}]*font-weight:\s*760;/s);
