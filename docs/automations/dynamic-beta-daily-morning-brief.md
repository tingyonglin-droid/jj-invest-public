...
- 美國科技巨頭及其對指數估值的影響；
- 台灣科技與半導體供應鏈；
- 台灣信用交易以 M 平方「大盤融資維持率」、融資餘額與可能的追繳／斷頭壓力為主要觀察；
- 重要財報與經濟數據；
...
- 台股融資維持率固定引用 M 平方「大盤融資維持率」，晨報不並列金管會官方整戶擔保維持率，避免混淆。130% 僅作為去槓桿與斷頭壓力升高的警戒參考，不得直接寫成必然見底點；是否出現籌碼清洗後的止穩，還要搭配融資餘額下降與價格行為判斷。
